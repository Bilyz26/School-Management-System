...
namespace prj_ForYou
{
    public partial class frmExplorer : Form
    {
        ...
        private void btnrechercher_emplpargrp_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = MemberGlobal.rechercher(string.Format("select distinct dayy as 'Jour',heureD as 'Heure Début',heureF as 'Heure Fin' from seance inner join Raff " +
        ...
        {
            //dgv.Size = new Size(687, 213);
            DataTable dt = MemberGlobal.rechercher(string.Format("select dayy as 'Jour',heureD as 'Heure Début',heureF as 'Heure Fin' from seance where #codegrp='{0}' and #annee='{1}'", cmbgroup.Text, cmbanneee.Text));
            if (dt.Rows.Count != 0)
            {
                dataGridView1.Hide();
                dgv.Show();
        ...
        private void txtcinornom_KeyPress(object sender, KeyPressEventArgs e)
        {
